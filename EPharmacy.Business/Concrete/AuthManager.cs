...
using EPharmacy.Business.Constants;
using EPharmacy.Core.Entities.Concrete;
using EPharmacy.Core.Utilities.Results.Abstract;
using EPharmacy.Core.Utilities.Results.Concrete;
using EPharmacy.Core.Utilities.Security.Hashing;
...
namespace EPharmacy.Business.Concrete
{
